    ...
    errors = validate_runtime_env(
        {
            "APP_ENV": "production",
            "JWT_SECRET_KEY": "x" * 32,
            "STRIPE_SECRET_KEY": "stripe_live_prod",
            "STRIPE_PUBLIC_KEY": "stripe_public_live_prod",
    ...
    errors = validate_runtime_env(
        {
            ...
            "REDIS_URL": "redis://localhost:6379/0",
            "JWT_SECRET_KEY": "x" * 40,
            "STRIPE_SECRET_KEY": "stripe_test_dev",
            "STRIPE_PUBLIC_KEY": "stripe_public_test_dev",
        },
        target_env="development",
    )
    ...
    errors = validate_runtime_env(
        {
            ...
            "STRIPE_SECRET_KEY": "stripe_live_REPLACE_ME",
            "STRIPE_PUBLIC_KEY": "stripe_public_live_REPLACE_ME",
