"""backend/api/services/knowledge_weapon_service.py — Knowledge Weapon AI service"""
from __future__ import annotations
import httpx
from api.config import settings

SYSTEM_PROMPT = "You are a Knowledge Weapon System. Transform any content (books, videos, articles) into structured action plans."


async def run_knowledge_weapon(content: str, context: str = "") -> tuple[str, int]:
