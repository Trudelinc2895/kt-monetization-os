"""backend/api/services/decision_engine_service.py — Decision Engine AI service"""
from __future__ import annotations
import httpx
from api.config import settings

SYSTEM_PROMPT = "You are an AI Decision Engine. Analyze situations and provide structured decisions with pros/cons and clear recommendations."


async def run_decision_engine(content: str, context: str = "") -> tuple[str, int]:
