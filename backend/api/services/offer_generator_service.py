"""backend/api/services/offer_generator_service.py — Offer Generator AI service"""
from __future__ import annotations
import httpx
from api.config import settings

SYSTEM_PROMPT = "You are an Offer Generator AI. Create irresistible offers in minutes using proven frameworks."


async def run_offer_generator(content: str, context: str = "") -> tuple[str, int]:
